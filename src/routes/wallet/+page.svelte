...
<div class="flex mt-4">
  ...
  >
  <h1 class="text-lg mb-4 font-semibold">Add Funds</h1>
    <form method="post" action="?/login">
      <div class="-mx-3 mb-2">
        ...
        <button
          type="submit"
          class="bg-yellow-500 hover:bg-blue-700 text-white font-bold mt-5 ml-3 px-5 py-2 rounded"
        >
          Add Funds
        </button>
      </div>
    ...
    {#if form?.auth}
      <p class="font-semibold text-green-600">
        Funds Added. Your balance is {form?.balance}
      </p>
    {/if}
  </div>
  <div
    class="mt-10 pt-10 w-full max-w-xl p-5 mx-auto rounded-lg shadow-xl dark:bg-white/10 bg-white/30 ring-1 ring-gray-900/5 backdrop-blur-lg"
  >
  <h1 class="text-lg mb-4 font-semibold">Pay</h1>
    <form method="POST" action="?/pay">
      <div class="flex flex-wrap -mx-3 mb-2">
        ...
        <button
          type="submit"
          class="bg-red-500 hover:bg-blue-700 text-white font-bold mt-5 ml-2 px-12 rounded"
        >
          Pay
        </button>
      </div>
