<section class="bg-gray-100 min-h-screen flex flex-col justify-center py-6">
    ...
    <div class="bg-teal-300 container mx-auto max-w-md rounded-2xl shadow-lg p-8">
      <h2 class="text-center mb-8 text-2xl font-semibold text-gray-900">Create Your Account</h2>
      <form class="space-y-6">
        ...
        <div class="flex items-center">
          ...
          <label for="terms" class="text-white">
            I agree to the <a href="#" class="text-blue-200 underline hover:text-blue-300">Terms and Conditions</a>
          </label>
        </div>
        <div>
          <button
